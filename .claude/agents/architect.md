...
2. Produce a plan: the approach, the files touched, the order of changes, and the risks. Prefer the smallest design that works for a personal site — no speculative abstraction.
