...
export default function Home() {
  return (
    <div className='flex h-screen w-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black'>
      ...
      <h1 className='text-edge-outline z-10 animate-title cursor-default whitespace-nowrap bg-white bg-clip-text pb-5 font-display text-4xl text-transparent duration-1000 sm:text-6xl md:text-9xl'>
        aviously.me
      </h1>
