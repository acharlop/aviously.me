    ...
    <header ref={ref} className='relative isolate overflow-hidden bg-gradient-to-tl from-black via-zinc-900 to-black'>
      <div
        className={`fixed inset-x-0 top-0 z-50 border-b backdrop-blur duration-200 lg:bg-transparent lg:backdrop-blur-none ${
          isIntersecting ? 'border-transparent bg-zinc-900/0' : 'border-zinc-200  bg-white/10 lg:border-transparent'
        }`}
      >
        <div className='container mx-auto flex flex-row-reverse items-center justify-between p-6'>
          <div className='flex justify-between gap-8'>
            ...
            >
              <Eye className='h-5 w-5' /> {Intl.NumberFormat('en-US', {notation: 'compact'}).format(views)}
            </span>
